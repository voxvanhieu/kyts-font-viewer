...
Func _Create_MainGUI()
    ...
    GUICtrlSetCursor(-1, 0)
    GUICtrlSetFont(-1, 10, 0, 0, "Lucida Console", 5)
...
Func _TabCustomText_SetState()          ;~ Thay đổi trạng thái bật/tắt của các kiểu trong customtext
	Switch @GUI_CtrlId
		Case $bt_Bold
	...
	EndSwitch
EndFunc
Func _inp_Tab_CustomText_SetStyle()     ;~ Chỉnh font chữ cho CustomText
...
EndFunc
Func _GetCharMapControlPos()            ;~ Lấy vị trí của ký tự đang được hiển thị trên charmap
...
;================
Func _GotoFile($aFileList, $iFlag = 0)		;~ Tìm file tiếp theo phù hợp từ TreeView
	Local $I
